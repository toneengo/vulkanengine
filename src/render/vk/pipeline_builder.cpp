...
static VkPipelineDepthStencilStateCreateInfo _pipeline_depth_stencil_state_create_info(bool depthTestEnable, bool depthWriteEnable, VkCompareOp compareOp,
                                                                                       bool depthBoundsTestEnable, bool stencilTestEnable, VkStencilOpState front,
...
VkPipeline GraphicsPipelineBuilder::build() {
    ...
    VkPipelineDynamicStateCreateInfo _d = {.sType             = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO,
                                           .pNext             = VK_NULL_HANDLE,
                                           .flags             = 0,
    ...
    if (vkCreateGraphicsPipelines(spock::ctx.device, VK_NULL_HANDLE, 1, &info, nullptr, &pipeline) != VK_SUCCESS) {
