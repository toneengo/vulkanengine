...
namespace info
{
    namespace create
    {
        ...
        VkPipelineLayoutCreateInfo pipeline_layout(std::initializer_list<VkDescriptorSetLayout> descriptorSetLayouts, std::initializer_list<VkPushConstantRange> pushConstantRanges);
